...
export default function DeploymentModal({ closeModal }) {
    return (
        <div className="overlays">
            <div className="popUp">
                <div className="popUp__close" onClick={() => closeModal()}></div>

                <h2 style={{ width: "100%", margin: "2rem", textAlign: "center" }}>
                ...
                <div style={{ display: "flex", width: "100%", flexWrap: "wrap" }}>
                    ...
                    >
                        <img
                            width={200}
                            src="https://www.switchautomation.com/wp-content/uploads/2021/06/Microsoft_Azure-Logo.wine_.png"
                        />
                        coming soon
                    </div>
                </div>
